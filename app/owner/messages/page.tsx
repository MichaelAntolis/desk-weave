...
const THREADS = [
  {
    ...
    lastMsg: "Hi, I just submitted my payment proof for the Skyline Suite.",
    time: "10:42 AM",
    unread: 2,
    online: true,
  },
  {
    ...
    lastMsg: "System maintenance is scheduled for October 12th.",
    time: "Yesterday",
    unread: 1,
    online: false,
  },
  {
    ...
    lastMsg: "Thanks! See you tomorrow.",
    time: "Tuesday",
    unread: 0,
    online: true,
  }
...
export default function OwnerMessagesPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-surface">
      {/* Standardized Header */}
      <header className="hidden md:flex flex-row justify-between items-center px-4 md:px-8 py-4 md:py-6 w-full max-w-full bg-surface-container-lowest/80 backdrop-blur-xl sticky top-0 z-30 border-b border-outline/10 h-[88px] md:h-[104px]">
        <div className="flex flex-col justify-center">
          <h1 className="text-xl md:text-2xl font-headline font-extrabold tracking-tight text-primary leading-tight">Messages</h1>
          <p className="text-on-surface-variant font-medium mt-1 text-xs md:text-sm hidden md:block">Kelola komunikasi dan pemberitahuan Anda.</p>
        </div>
        <div className="flex items-center gap-4">
          <div className="relative hidden md:block">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-outline w-4 h-4" />
            <Input
              className="pl-9 pr-4 py-2 bg-surface-container-low border-none focus-visible:ring-2 focus-visible:ring-primary w-64 transition-all"
          ...
          <div className="hidden md:flex items-center gap-3 pl-4 border-l border-outline/20">
            ...
            <div className="text-right ml-2">
              ...
              <p className="text-xs text-on-surface-variant uppercase tracking-wider">Premium Owner</p>
            </div>
            <ProfileMenu role="owner" avatarUrl="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&q=80" />
          </div>
        </div>
      </header>

      {/* Main Inbox Layout */}
      <section className="flex flex-1 max-w-7xl mx-auto w-full px-0 md:px-8 py-0 md:py-6 overflow-hidden max-h-[calc(100vh-104px)]">
        ...
        <div className={cn(
          ...
          {activeData ? (
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <div className="flex items-end gap-2">
                    ...
                    <div className="bg-surface border border-outline/5 px-4 py-3 rounded-2xl rounded-bl-sm max-w-[85%] md:max-w-[70%] shadow-sm">
                      <p className="text-sm font-medium text-on-surface">Hello DeskWeave, I have attached my payment proof for the Skyline Suite 402.</p>
                      <span className="text-[10px] text-outline mt-2 block w-full">10:40 AM</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-end gap-2 justify-end">
                    <div className="gradient-primary text-white px-4 py-3 rounded-2xl rounded-br-sm max-w-[85%] md:max-w-[70%] shadow-md">
                      <p className="text-sm font-medium text-white/90">Hi Alex! Received. I will verify it right now and update your status.</p>
                      <div className="flex justify-end items-center gap-1 mt-1">
                        <span className="text-[10px] text-white/60">10:41 AM</span>
                  ...
                  <div className="flex items-end gap-2">
                    ...
                    <div className="bg-surface border border-outline/5 px-4 py-3 rounded-2xl rounded-bl-sm max-w-[85%] md:max-w-[70%] shadow-sm">
                      <p className="text-sm font-medium text-on-surface">Great, thank you. Can't wait!</p>
                      <span className="text-[10px] text-outline mt-2 block w-full">10:42 AM</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-surface/30">
              ...
              <p className="text-xs text-on-surface-variant max-w-xs mt-2">Choose an existing conversation from the list or start a new chat with a tenant.</p>
            </div>
          )}
        </div>
